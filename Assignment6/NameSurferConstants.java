 ...
 * 
 * This file declares several constants that are shared by the different modules in the 
 * NameSurfer application. Any class that implements this interface can use these constants.
 */
...
public interface NameSurferConstants {
	...
	/* The maximum number of columns in the text entry field */
