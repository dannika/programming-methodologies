/*
 * File: FacePamphletProfileExtended.java
 * ------------------------------
 ...
 * 
 * Extensons include:
 * (1) Addition "getter" and "setter" methods that get and return the name of an image file.
 */

import acm.graphics.*;
import java.util.*;

public class FacePamphletProfileExtended implements FacePamphletConstantsExtended {
	 ...
	 */
	public FacePamphletProfileExtended(String name) {
		profileName = name;
		currentStatus = "";
	...
	/* Method: setImageFileName(file) */
	/**
	 * Updates the name of the image file associated with the
	 * profile.
	 * 
	...
	/**
	 * Returns the name of the image file associated with the
	 * current profile.
	 * 
	 * @return String imageFileName, the name of the image file
	 */
